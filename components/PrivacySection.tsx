...
const PrivacySection: React.FC = () => {
  return (
    <SectionWrapper id="privacy" title="Your Privacy, Our Priority" subtitle="We are building a foundation of trust and transparency.">
      <div className="max-w-2xl mx-auto text-center bg-brand-dark p-6 md:p-10 rounded-xl border border-brand-gold/30 shadow-lg animate-fade-in-up" style={{animationDelay: '1.4s'}}>
        <FingerPrintIcon className="w-12 h-12 md:w-16 md:h-16 text-brand-gold mx-auto mb-6 opacity-70"/>
        <h3 className="text-xl md:text-2xl font-display font-semibold text-brand-gold mb-4">Commitment to Data Protection</h3>
